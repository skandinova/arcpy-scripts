...
def lidar_process(in_lidar, final_out):
    ...
    xy_result = r"G:\Tools\LidarToTopo\temp_data.gdb\xy_result"
    ...
    ras_result = r"G:\Tools\LidarToTopo\temp_data.gdb\ras_result"
    ...
    con_result = r"G:\Tools\LidarToTopo\temp_data.gdb\con_result"
...
def sp_project(in_points, out_proj):
    state_plane = r"G:\Tools\LidarToTopo\temp_data.gdb\CA_State_Plane_Zones"

    # Perform summarize within tool to find number of lidar points in each state plane
    sum_within = r"G:\Tools\LidarToTopo\temp_data.gdb\sum_within"
...
def get_ps(lidar_points):
    ...
    las_result = r"G:\Tools\LidarToTopo\temp_data\las_result.las"
    las_com = fr"G:\Tools\LAStools\bin\shp2las.exe -i {lidar_points} -o {las_result}"
    os.system(las_com)
